        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/barang/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(kode_barang,5) as kode FROM is_barang
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT kode_barang,nama_barang,harga_beli,satuan FROM is_barang WHERE kode_barang='$_GET[id]'") 
