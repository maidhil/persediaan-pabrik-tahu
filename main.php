...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Pabrik Tahu dan Tempe</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Persediaan Pabrik Tahu dan Tempe">
    <meta name="author" content="Muhammad Aidhil" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <span style="font-size:20px">Pabrik Mbak Sri</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 - <a href="">maidhil</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
