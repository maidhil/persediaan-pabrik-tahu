...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.kode_terpakai,a.tanggal_pakai,a.kode_barang,a.jumlah_pakai,b.kode_barang,b.nama_barang,b.satuan
                                    FROM is_barang_pakai as a INNER JOIN is_barang as b ON a.kode_barang=b.kode_barang
                                    WHERE a.tanggal_pakai BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                    ORDER BY a.kode_terpakai ASC") 
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA BARANG TERPAKAI</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA BARANG TERPAKAI <br>
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">KODE TERPAKAI</th>
                        ...
                        <th height="20" align="center" valign="middle">JUMLAH TERPAKAI</th>
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='120' height='13' align='center' valign='middle'>$data[kode_terpakai]</td>
                        <td width='80' height='13' align='center' valign='middle'>$tanggal_pakai</td>
                        ...
                        <td style='padding-right:10px;' width='100' height='13' align='right' valign='middle'>$data[jumlah_pakai]</td>
...
<?php
$filename="LAPORAN DATA BARANG TERPAKAI.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
