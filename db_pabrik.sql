...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2021 at 04:25 AM
...
('EOQ00009', '2021-07-10', 'B00009', 100, 5000, '20000', 7, 1, '2021-07-10 03:01:23'),
('EOQ00010', '2021-07-28', 'B00002', 1000, 400, '2000', 100, 1, '2021-07-28 16:48:40'),
('EOQ00011', '2021-07-28', 'B00001', 3600, 90000, '6000000', 693, 1, '2021-07-28 16:51:11');
...
('B00009', 'Baskom', 20000, 0, 'Pcs', 8, 1, '2021-07-10 02:57:14', 1, '2021-07-10 02:59:29');
...
('BM-2021-00009', '2021-07-10', 'B00009', 10, 1, '2021-07-10 02:58:38');
...
('BT-2021-00009', '2021-07-10', 'B00009', 2, 1, '2021-07-10 02:59:29');
...
(1, 'admin', 'Admin', 'admin', 'Maidhil27.ma@gmail.com', '082375829583', 'user 1.png', 'Super Admin', 'aktif', '2021-01-31 15:41:55', '2021-07-10 02:47:04'),
(2, 'manajer', 'manajer', 'manajer', 'manajer@gmail.com', '085680892909', 'kadina.png', 'Manajer', 'aktif', '2017-04-01 08:15:15', '2021-07-04 18:28:33'),
(3, 'gudang', 'gudang', 'gudang', 'gudang@gmail.com', '085758858855', 'user 3.png', 'Gudang', 'aktif', '2017-04-01 08:15:15', '2021-07-04 18:28:53');
...
--
-- Constraints for table `is_analisa_eoq`
--
ALTER TABLE `is_analisa_eoq`
  ADD CONSTRAINT `is_analisa_eoq_ibfk_1` FOREIGN KEY (`created_user`) REFERENCES `is_users` (`id_user`);
