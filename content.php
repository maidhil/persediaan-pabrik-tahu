...
// jika user sudah login, maka jalankan perintah untuk pemanggilan file halaman konten
	...
	// jika halaman konten yang dipilih barang masuk, panggil file view barang terpakai
	elseif ($_GET['module'] == 'barang_terpakai') {
		include "modules/barang-terpakai/view.php";
	}

	// jika halaman konten yang dipilih form barang masuk, panggil file form barang terpakai
	elseif ($_GET['module'] == 'form_barang_terpakai') {
		include "modules/barang-terpakai/form.php";
	}
	// -----------------------------------------------------------------------------

	// jika halaman konten yang dipilih barang masuk, panggil file view barang terpakai
	elseif ($_GET['module'] == 'analisa_eoq') {
		include "modules/analisa-eoq/view.php";
	}

	// jika halaman konten yang dipilih form barang masuk, panggil file form barang terpakai
	elseif ($_GET['module'] == 'form_analisa_eoq') {
		include "modules/analisa-eoq/form.php";
	}
	// -----------------------------------------------------------------------------
	...
	// jika halaman konten yang dipilih laporan barang masuk, panggil file view laporan barang terpakai
	elseif ($_GET['module'] == 'lap_barang_terpakai') {
		include "modules/lap-barang-terpakai/view.php";
	}
	// -----------------------------------------------------------------------------

	// jika halaman konten yang dipilih laporan barang masuk, panggil file view laporan analisa eoq
	elseif ($_GET['module'] == 'lap_analisa_eoq') {
		include "modules/lap-analisa-eoq/view.php";
	}
	// -----------------------------------------------------------------------------
